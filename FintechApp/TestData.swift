...
let conversationsTestData = [
    [
        ...
        ConversationCellModel(name: "Alex", message: "", date: Date().addingTimeInterval(-12000), isOnline: false, hasUnreadMessages: false),
        ...
        ConversationCellModel(name: "Joe", message: "Qwerty?", date: Date().addingTimeInterval(-189000), isOnline: false, hasUnreadMessages: true),
